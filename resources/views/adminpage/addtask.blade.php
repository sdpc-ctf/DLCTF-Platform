          ...
          <div class="tpl-block">
            <div class="am-g">
              <div class="tpl-form-body tpl-form-line">
                <form action="{{url('ctfadmin/task/add')}}" class="am-form tpl-form-line-form" method="POST">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                  <div class="am-form-group">
                    ...
                    <div class="am-u-sm-9">
                      <input type="text" class="tpl-form-input" name="taskname" placeholder="请输入标题文字"></div>
                  </div>
                  <div class="am-form-group">
                  ...
                  <div class="am-form-group">
                    ...
                    <div class="am-u-sm-9">
                      <textarea class="" rows="10" name="taskdata" placeholder="请输入题目内容"></textarea>
                    </div>
                  </div>
                  <div class="am-form-group">
